...
class StandardsContainer extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.OA.A.1</strong> - Interpret a multiplication equation as a comparison.
</MDBMedia>
...
export default connect(mapStateToProps)(StandardsContainer)
