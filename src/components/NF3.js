...
class NF3 extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.NF.B.3</strong> - Understand a fraction a/b with a > 1 as a sum of fractions 1/b.
</MDBMedia>
...
export default connect(mapStateToProps)(NF3)
