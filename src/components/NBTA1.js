...
class NBTA1 extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.NBT.A.1</strong> - Recognize that in a multi-digit whole number, a digit in one place represents ten times what it represents in the place to its right.
</MDBMedia>
...
export default connect(mapStateToProps)(NBTA1)
