...
class OAC5 extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.OA.C.5</strong> - Generate a number or shape pattern that follows a given rule.
</MDBMedia>
...
<Card.Header>Identifying Pattern Attributes</Card.Header>
<Card.Body>
  <Card.Title>In a pattern the first number is a 5. The second number is a 10. The third is a 15. Fourth is a 20. If the pattern continues will the 14th number end in a 5 or a 0?</Card.Title>
  {/* <Card.Text>
...
<Card.Header>Identifying Pattern Attributes</Card.Header>
<Card.Body>
  <Card.Title>In a pattern the first number is a 2. The second number is a 4. The third is a 6. Fourth is a 8.
If the pattern continues what will be the 13th number in the pattern?</Card.Title>
  {/* <Card.Text>
...
<Card.Header>Creating Patterns</Card.Header>
<Card.Body>
  <Card.Title>Start at 25 and create a pattern with the rule add 9. What is the fourth number in the pattern?</Card.Title>
  {/* <Card.Text>
...
export default connect(mapStateToProps)(OAC5)
