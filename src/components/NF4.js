...
class NF4 extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.NF.B.4</strong> - Apply and extend previous understandings of multiplication to multiply a fraction by a whole number.
</MDBMedia>
...
export default connect(mapStateToProps)(NF4)
