...
class NF1 extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.NF.A.1</strong> - Explain why a fraction a/b is equivalent to a fraction by using visual fraction models.
</MDBMedia>
...
<Card.Header>Equivalent Fractions</Card.Header>
<Card.Body>
  <Card.Title>Find an equivalent fraction for 2/16</Card.Title>
  {/* <Card.Text>
...
<Card.Header>Equivalent Fractions</Card.Header>
<Card.Body>
  <Card.Title>Find an equivalent fraction for 18/20</Card.Title>
  {/* <Card.Text>
...
<Card.Header>Equivalent Fractions</Card.Header>
<Card.Body>
  <Card.Title>Find an equivalent fraction for 6/36</Card.Title>
  {/* <Card.Text>
...
export default connect(mapStateToProps)(NF1)
