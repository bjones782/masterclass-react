...
class OAA2 extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.OA.A.2</strong> - Multiply or divide to solve word problems involving multiplicative comparison.
</MDBMedia>
...
<Card.Header>Multiplication Comparisons within 100</Card.Header>
<Card.Body>
  <Card.Title>A library checks out four fiction books and two non-fiction books an hour. How
many times more fiction books do they check out than non-fiction books?</Card.Title>
  {/* <Card.Text>
...
<Card.Header>Multiplication Comparisons within 100</Card.Header>
<Card.Body>
  <Card.Title>There were twenty-one adults in line at a movie theater. That is three times the
number of children in line. How many children were in line?</Card.Title>
  {/* <Card.Text>
...
<Card.Header>Multiplication Comparisons within 100</Card.Header>
<Card.Body>
  <Card.Title>A restaurant sold eight times as many salads as they sold steaks. If they sold four
steaks, how many salads did they sell?</Card.Title>
  {/* <Card.Text>
...
export default connect(mapStateToProps)(OAA2)
