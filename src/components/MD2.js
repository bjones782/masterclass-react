...
<strong>4.MD.A.2</strong> - Use the four operations to solve word problems involving distances, intervals of time, liquid volumes, masses of objects, and money.
</MDBMedia>
<button className="helpbtn" onClick={this.handleIsClicked}><i class="fas fa-question-circle"></i></button>
</MDBMedia>
</MDBMedia>
...
<Card.Header>Determining Value</Card.Header>
<Card.Body>
  <Card.Title>Determine which number has the greatest value:</Card.Title>
  <Card.Text>
...
<Card.Header>Ordering Decimal Numbers</Card.Header>
<Card.Body>
  <Card.Title>Order the numbers from least to greatest.</Card.Title>
  <Card.Text>
...
<Card.Header>Ordering Money</Card.Header>
<Card.Body>
  <Card.Title>Order from least to greatest.</Card.Title>
  <Card.Text>
...
export default connect(mapStateToProps)(MD2)
