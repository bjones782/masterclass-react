...
class NBTB4 extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.NBT.B.4</strong> - Fluently add and subtract multi-digit whole numbers using the standard algorithm.
</MDBMedia>
...
<Card.Header>Four Digit plus Four Digit Addition</Card.Header>
<Card.Body>
  <Card.Title>8,293 + 3,790 </Card.Title>
  {/* <Card.Text>
...
<Card.Header>4 Digit Minus 4 Digit</Card.Header>
<Card.Body>
  <Card.Title>3,562 - 2,102</Card.Title>
  {/* <Card.Text>
...
<Card.Header>Subtracting Across Zeros</Card.Header>
<Card.Body>
  <Card.Title>70,001 - 1,618</Card.Title>
  {/* <Card.Text>
...
export default connect(mapStateToProps)(NBTB4)
