...
class MD3 extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.MD.A.3</strong> - Apply the area and perimeter formulas for rectangles in real world and mathematical problems.
</MDBMedia>
...
export default connect(mapStateToProps)(MD3)
