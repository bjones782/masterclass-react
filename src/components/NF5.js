...
class NF5 extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.NF.C.5</strong> - Express a fraction with denominator 10 as an equivalent fraction with denominator 100.
</MDBMedia>
...
export default connect(mapStateToProps)(NF5)
