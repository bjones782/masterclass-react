...
class NBTC5 extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.NBT.C.5</strong> - Multiply a whole number of up to four digits by a one-digit whole number, and multiply two two-digit numbers, using strategies based on place value and the properties of operations.
</MDBMedia>
...
<Card.Header>Multiply 2 x 2</Card.Header>
<Card.Body>
  <Card.Title>19 × 42</Card.Title>
  {/* <Card.Text>
...
<Card.Header>Multiply 3 x 2</Card.Header>
<Card.Body>
  <Card.Title>276 × 53</Card.Title>
  {/* <Card.Text>
...
<Card.Header>Multiply 4 x 1</Card.Header>
<Card.Body>
  <Card.Title>8,107 × 5</Card.Title>
  {/* <Card.Text>
...
export default connect(mapStateToProps)(NBTC5)
