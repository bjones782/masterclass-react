...
<strong>4.G.A.1</strong> - Draw points, lines, line segments, rays, angles (right, acute, obtuse), and perpendicular and parallel lines.
</MDBMedia>
...
export default connect(mapStateToProps)(G1)