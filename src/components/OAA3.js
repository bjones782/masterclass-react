...
class OAA3 extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.OA.A.3</strong> - Solve multistep word problems posed with whole numbers and having whole-number answers using the four operations.
</MDBMedia>
...
<Card.Header>Solving Words Problems (+ - ÷ ×)</Card.Header>
<Card.Body>
  <Card.Title>Vanessa was buying DVDs of her
          old favorite TV series. She bought
          eight DVDs at the store and she
          bought seven online. How many
          DVDs did she buy total?</Card.Title>
  {/* <Card.Text>
...
<Card.Header>Solving Words Problems (+ - ÷ ×)</Card.Header>
<Card.Body>
  <Card.Title>A mailman has to give twenty-eight
          pieces of junk mail to each block. If
          there are four houses on a block
          how many pieces of junk mail
          should he give each house ?</Card.Title>
  {/* <Card.Text>
...
<Card.Header>Solving Words Problems (+ - ÷ ×)</Card.Header>
<Card.Body>
  <Card.Title>Roger could fit seven action figures
          on each shelf in his room. His room
          has two shelves. How many action
          figures total could his shelves hold?</Card.Title>
  {/* <Card.Text>
...
export default connect(mapStateToProps)(OAA3)
