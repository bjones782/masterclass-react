...
class Footer extends React.Component{
    ...
    render(){
        ...
        return (
          <footer id="sticky-footer" class="py-4 bg-dark text-white-50 navbar-fixed-bottom">
      ...
      <small> © 2019 Copyright:  Made with <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Heart_coraz%C3%B3n.svg/1200px-Heart_coraz%C3%B3n.svg.png" alt="heart" width="2%"/> by Brooke Jones </small>
    </div>
  </footer>
  // </Segment>
        )
