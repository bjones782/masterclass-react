...
class NF2 extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.NF.A.2</strong> - Compare two fractions with different numerators and different denominators.
</MDBMedia>
...
export default connect(mapStateToProps)(NF2)
