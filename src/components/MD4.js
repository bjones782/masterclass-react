...
class MD4 extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.MD.B.4</strong> - Make a line plot to display a data set of measurements in fractions of a unit (1/2, 1/4, 1/8).
</MDBMedia>
...
export default connect(mapStateToProps)(MD4)
