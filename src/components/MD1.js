...
<strong>4.MD.A.1</strong> - Know relative sizes of measurement units within one system of units.
</MDBMedia>
...
<Card.Header>Estimating Metric Length</Card.Header>
<Card.Body>
  <Card.Title>Which metric unit best represents the distance from NYC to Albany, NY?</Card.Title>
  <Card.Text>
        <NumberFormat prefix={'  A. '} value={'cm'} displayType={'text'} thousandSeparator={true} renderText={value => <div>{value}</div>} />
        <NumberFormat prefix={'  B. '} value={'m'} displayType={'text'} thousandSeparator={true} renderText={value => <div>{value}</div>} />
        <NumberFormat prefix={'  C. '} value={'km'} displayType={'text'} thousandSeparator={true} renderText={value => <div>{value}</div>} />
        <NumberFormat prefix={'  D. '} value={'mm'} displayType={'text'} thousandSeparator={true} renderText={value => <div>{value}</div>} />
  </Card.Text>
</Card.Body>
</Card>
</div><br></br>
...
<Card.Header>Comparing Weights</Card.Header>
<Card.Body>
  <Card.Title>6,594 grams __ 5 kilograms.</Card.Title>
  {/* <Card.Text>
...
<Card.Header>Estimating Weight</Card.Header>
<Card.Body>
  <Card.Title>Determine which letter best represents the weight of a dresser.</Card.Title>
  <Card.Text>
...
export default connect(mapStateToProps)(MD1)
