...
class G3 extends React.Component {
    constructor(props){
        super(props)
...
<strong>4.G.A.3</strong> - Recognize a line of symmetry for a two-dimensional figure as a line across the figure such that the figure can be folded along the line into matching parts.
</MDBMedia>
...
export default connect(mapStateToProps)(G3)